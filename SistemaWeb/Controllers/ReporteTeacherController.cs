...
namespace SistemaWeb.Controllers
{
    ...
    public class ReporteTeacherController : Controller
    {
        ...
        public ActionResult Index()
        {
           ...
           string user = (Session["user"]).ToString();
            ...
            cmd1.CommandText = "select p.nombre, p.inss   from AspNetUsers a, profesores p where p.direccion = a.Email and a.UserName = '" + Users +"'; ";
            ...
            string nombre = dataTable1.Rows[0].ItemArray[0].ToString();
            string inss = dataTable1.Rows[0].ItemArray[1].ToString();
            ...
            horariogeneracion horariogeneracion1 = new horariogeneracion();
            horariogeneracion1.profesor = inss;
            return View();
        }
        ...
        public ActionResult BusquedaProfesorHorario(horariogeneracion ph)
        {
             ...
             if (ph.profesor == null) {                       
           string profes = (Session["nombre"]).ToString();
            ph.profesor = profes;
            }
